...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by ✪ 𝐓𝐄𝐀𝐌 𝐒𝐍𝐒 ✪"""
    JSON_TXT = """<b>JSON:</b>
...
╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗
✇ <a href=https://t.me/MoviesNSeriesSNS> ⚜ 𝐌𝐀𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ⚜ </a>

✇ <a href=https://t.me/MOVIESNSERIESGROUPSNS> 🔰 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏 🔰 </a>
╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>"""
...
Merry Christmas ❄️ and Happy New Year 🎇</b>"""
    ...
    OLD_ALRT_TXT = """𝐘𝐨𝐮 𝐚𝐫𝐞 𝐮𝐬𝐢𝐧𝐠 𝐨𝐧𝐞 𝐨𝐟 𝐦𝐲 𝐨𝐥𝐝 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬, 𝐩𝐥𝐞𝐚𝐬𝐞 𝐬𝐞𝐧𝐝 𝐭𝐡𝐞 𝐫𝐞𝐪𝐮𝐞𝐬𝐭 𝐚𝐠𝐚𝐢𝐧 ✪ 𝐓𝐄𝐀𝐌 𝐒𝐍𝐒 ✪"""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CUDNT_FND = """𝗛𝗲𝗹𝗹𝗼 {} 𝗜 𝗖𝗼𝘂𝗹𝗱𝗻'𝘁 𝗙𝗶𝗻𝗱 𝗔𝗻𝘆𝘁𝗵𝗶𝗻𝗴 𝗥𝗲𝗹𝗮𝘁𝗲𝗱 𝗧𝗼 𝗬𝗼𝘂𝗿 𝗤𝘂𝗲𝗿𝘆.𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝗲𝗮𝗿𝗰𝗵 𝗬𝗼𝘂𝗿 𝗦𝗽𝗲𝗹𝗹𝗶𝗻𝗴 𝗛𝗘𝗥𝗘 \n\n<a href=https://www.google.com/search?q={search}>𝐒𝐞𝐚𝐫𝐜𝐡 𝐎𝐧 𝐆𝐎𝐎𝐆𝐋𝐄</a>"""
